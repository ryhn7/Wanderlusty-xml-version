...
class RestaurantSectionTwoAdapter :
    ...
    private lateinit var onItemClickCallback: RestaurantSectionTwoAdapter.OnItemClickCallback

    fun setOnItemClickCallback(onItemClickCallback: RestaurantSectionTwoAdapter.OnItemClickCallback) {
