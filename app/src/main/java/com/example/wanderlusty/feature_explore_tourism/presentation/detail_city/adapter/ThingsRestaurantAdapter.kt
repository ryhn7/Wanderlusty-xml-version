...
class ThingsRestaurantAdapter :
    ...
    private lateinit var onItemClickCallback: ThingsRestaurantAdapter.OnItemClickCallback

    fun setOnItemClickCallback(onItemClickCallback: ThingsRestaurantAdapter.OnItemClickCallback) {
