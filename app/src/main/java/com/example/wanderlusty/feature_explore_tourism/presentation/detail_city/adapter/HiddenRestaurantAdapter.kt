...
class HiddenRestaurantAdapter : BaseAdapter<Restaurant, ItemCardOneBinding>(diffCallbackListener) {
    ...
    private lateinit var onItemClickCallback: HiddenRestaurantAdapter.OnItemClickCallback

    fun setOnItemClickCallback(onItemClickCallback: HiddenRestaurantAdapter.OnItemClickCallback) {
